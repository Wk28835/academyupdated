...
export default function Contact() {
  return (
    <div className="w-full mx-0 p-1">
      ...
      <div className="pt-12">
        <h1 className=" text-3xl font-serif lg:text-5xl text-center text-black font-semibold">
          Learn the Quran Verse by Verse with Us
        </h1>
        <div className="bg-yellow-400 w-1/5  h-1 m-5 mx-auto"></div>
        <h2 className="px-2 text-xl text-center text-gray-700 font-serif">
          Contact us by phone or complete the form, and we’ll get in touch with
          you shortly.
        </h2>
      </div>
      ...
      <div className="flex flex-wrap justify-center gap-8 px-4 mt-10 ">
        ...
        <div className="bg-white shadow-sm shadow-cyan-400 hover:shadow-lg hover:shadow-cyan-500 rounded-md p-6 w-full md:w-[600px]">
          <h1 className="mb-4 text-black font-serif text-center font-semibold text-2xl">
            Get Your Free
          </h1>
        ...
        <div className="bg-white shadow-sm rounded-md p-6 w-full md:w-[600px] shadow-cyan-400 hover:shadow-lg hover:shadow-cyan-500">
          <div className="border-2 border-[#13B4B6] pb-8">
            <div className="flex ">
              ...
              />
              <div>
                <h2 className="text-justify text-2xl font-bold font-serif mt-2  text-[#13B4B6] ">
                  USA CONTACT
                </h2>
                <p className=" pl-2 text-xl text-gray-700 font-semibold">
                  + 1 512 576 7126
                </p>
              </div>
            </div>
          ...
          <div className="border-2 mt-5 border-[#13B4B6] pb-8">
            <div className="flex ">
              ...
              <div>
                <h2 className="text-justify text-2xl font-bold font-serif   text-[#13B4B6] ">
                  Email
                </h2>
