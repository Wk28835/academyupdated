...
export default function Home() {
  return (
    <div className="w-full ">
      ...
      >
        <div className="absolute bg-teal-400 opacity-85 inset-0 bg-opacity-40 rounded-md flex flex-col justify-center items-center px-4 sm:px-6 py-2 gap-4">
      ...
      <div className="mt-16 pb-8 shadow-sm hover:shadow-md hover:shadow-teal-500 shadow-teal-400 sm:mt-16 mx-auto w-full max-w-screen-lg text-center px-4 sm:px-6">
        ...
        <p className="pt-3 pb-4 sm:pt-4 sm:pb-6 text-base sm:text-base md:text-base text-pretty">
          Enhance your Quranic and Islamic understanding through our expertly
          designed courses. Our structured programs include: Noorani Qaida,
          Quran Recitation, Tajweed, Quran Translation, Tafseer, Hifz
          (Memorization), Hadith Studies, Arabic Language, and Comprehensive
          Islamic Studies.
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 text-black mt-4 sm:grid-cols-2 lg:grid-cols-3 gap-6 px-4">
        {[
          ...
          },
          {
            ...
            desc: "Memorizing the Quran is a noble achievement. This course offers a structured memorization plan with daily lessons, revision schedules, and memory-building techniques. Students are guided by experienced Huffaz and receive motivation, encouragement, and consistent support to complete their Hifz journey successfully.",
          },
          {
            img: "/translate.jpg",
          ...
          },
          {
            ...
            desc: "This course is for students who want to learn the Arabic language to better understand the Quran and Hadith. It covers Arabic grammar, vocabulary, sentence structure, and basic conversation. Special focus is given to Quranic Arabic, enabling students to connect deeply with Islamic texts and gain insight directly from the original language.",
          },
          {
            img: "/studies.jpg",
            title: "Islamic Studies Courses",
            desc: "A complete and well-rounded course covering Aqeedah (belief), Ibadah (worship), Seerah (biography of the Prophet ﷺ), Fiqh (Islamic rulings), and Islamic manners. This course is suitable for children, teens, and adults. It provides a strong Islamic foundation along with practical guidance for living an Islamic life.",
          },
        ].map((course, idx) => (
          <div
            key={idx}
      ...
      <WhyUs />
      <div>
        <h1 className="text-2xl text-center pt-4 sm:text-3xl md:text-4xl font-bold text-black">
          Student Review
        </h1>
      <StudentReview/>
      </div>
      ...
      <div className="flex flex-wrap justify-center gap-8 px-4 mt-1 lg:mt-16">
        ...
        <div className="bg-white border-2 border-gray-300 shadow-sm hover:shadow-md hover:shadow-teal-500 shadow-teal-400 p-2 w-full md:w-[400px] rounded-md">
          <h1 className="lg:text-2xl text-center text-xl  text-black font-bold mb-4">
