...
export default function Reading() {
  ...
  return (
    <div className="w-full mx-0 p-1">
      ...
      >
        <div className="absolute inset-0   bg-opacity-100 shadow-lg flex flex-col lg:flex-row justify-between items-center px-10 py-1">
          <div className="text-white max-w-xl">
            <h2 className="font-semibold lg:text-3xl  text-xl  text-wrap lg:text-left px-4 lg:px-24">
              Quran Reading Course Online
            </h2>
            <p className="text-base lg:text-xl text-wrap  text-white pt-0 lg:text-left px-4 lg:px-24">
              Master Quran reading with expert instructors at Darul Ilm
      ...
      <div style={{ fontFamily: 'Roboto, sans-serif' }}
       className="flex flex-wrap justify-center gap-8 px-2 mt-6">
        <div className="bg-white border-1 border-gray-200 shadow-md p-4 w-full md:w-2/3 sm:w-1/4 rounded-md">
      ...
      <ClassInfo />
        ...
        <div className="flex flex-col lg:flex-row flex-wrap justify-center items-stretch gap-4 mt-4 lg:mt-10 px-4">
      ...
      <div className="flex flex-wrap justify-center gap-8 px-4 mt-4 lg:mt-16">
