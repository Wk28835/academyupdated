      ...
      >
        <div className="absolute inset-0 bg-opacity-100 shadow-lg flex flex-col lg:flex-row justify-between items-center px-10 py-4">
          <div className="text-white max-w-xl">
            <h2 className="font-semibold lg:text-3xl text-xl text-wrap pt-1 lg:text-left px-4 lg:px-24">
              Hadith Course Online
            </h2>
            <p className="lg:text-xl text-sm text-justify text-white  lg:text-left px-4 lg:px-24">
